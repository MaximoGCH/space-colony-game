...
func ApplyEasing(value int, minValue int, maxValue int, easing Easing) int {
	maxValueMinusMin := float64(maxValue - minValue)

	return int(easing(float64(value-minValue)/maxValueMinusMin)*maxValueMinusMin) + minValue
}
